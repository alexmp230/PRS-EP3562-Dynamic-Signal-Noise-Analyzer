...
|3\.1.8|Input configuration|<p>1. Single-ended</p><p>2. Differential</p>||M|
...
1. ### **3.2 Signal Generator**


|**Nr.**|**Category**|**Request**|**Comments**|**Typ**|
| :-: | :-: | :-: | :-: | :-: |
|3\.2.1|Source Output Types|<p>1. Random Noise</p><p>2. Burst Random</p><p>3. Sine Chirp</p><p>4. Burst Chirp</p><p>5. Fixed Sine</p><p>6. Swept Sine</p><p>7. Step</p><p>8. Pulse</p><p>9. Ramp</p><p>10. Arbitrary (Should?)</p>|Arbitrary (Should?)|M|
|3\.2.2|Amplitude Range Min.|0\.01 mVp||M|
|3\.2.3|Amplitude Range Max.|5 Vp||M|
|3\.2.4|Offset adjustment|±5 V||M|
|3\.2.5|DC Offset accuracy|±10 mV Typ.||M|
|3\.2.6|Amplitude Resolution High Range|0\.1 mVp (Output >= 500 mVp)||M|
|3\.2.7|Amplitude Resolution Low Range|0\.01 mVp (Output < 500 mVp)||M|
|3\.2.8|Amplitude accuracy sine source High Range|0\.01|Over the entire BW|M|
|3\.2.9|Amplitude accuracy sine source Low Range|0\.05|<p>Over the entire BW.</p><p>TBD, maybe 10%?</p>|M|
|3\.2.10|Output Impedance|< 5 Ω||M|
|3\.2.11|Output current max.|100 mApk||M|
|3\.2.12|Harmonic Distortion|< -80 dBc|Entire BW (With our 24 bit ADC, maybe we should ask for more)|M|
|3\.2.13|Inter-modulation dist.|< -80 dBc||M|
|3\.2.14|Spurious|< -80 dBfs||M|
|3\.2.15|Full-span FFT noise floor||Check what is possible with our SR560-like front-end|M|
|3\.2.16|Residual DC response|< -30 dBfs||M|
|3\.2.17|Phase Accuracy Single Channel resp. Trigger|± 3 deg.||M|
|3\.2.18|Phase Accuracy Single Channel resp. Trigger|± 0.5 deg.||M|
1. #
1. ### **3.3 Computer**
...
|**Nr.**|**Category**|**Request**|**Comments**|**Typ**|
| :-: | :-: | :-: | :-: | :-: |
|3\.5.1|Front Panel Connectors|<p>1. Input channels</p><p>2. Input channel grounding common</p><p>3. Source output</p><p>4. USB type C</p>||M|
|3\.5.2|Back Panel Connectors|<p>1. Reference input</p><p>2. Sync / reference output</p><p>3. Ext. sample (HP3562A)</p><p>4. Ethernet</p><p>5. 4x USB type A</p><p>6. 2x USB type C</p><p>7. Anti-thief lock</p><p>8. HDMI (tbd)</p>||M|
...
1. ### **3.6 Analog front-end (RS560 based)**
